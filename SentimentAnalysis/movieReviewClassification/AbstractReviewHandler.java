...
public abstract class AbstractReviewHandler {
     ...
     */
    public abstract void loadReviews(String filePath, int realClass) throws IOException;
    ...
    public abstract void loadSerialDB() throws IOException, ClassNotFoundException;
