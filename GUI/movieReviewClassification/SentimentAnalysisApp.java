 ...
 *
 ...
 referenced to QuintonWilliams21 on github
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    static private final JLabel commandLabel = new JLabel("Please select a command",JLabel.RIGHT);

    static private final JComboBox comboBox = new JComboBox();

    static private final JButton databaseButton = new JButton("Database Table");
...

    {
        ...
        JFrame frame = new JFrame("Sentiment App");
...
//*******************************************************
     ...
     * 2: delete reviews from database.
...
//******************************************************************
...

    {
        ...
        resultFrame.setBounds((width - windowsWidth) / 4, (height - windowsHeight) / 4, windowsWidth, windowsHeight/2);
